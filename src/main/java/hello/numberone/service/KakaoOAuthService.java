...
import hello.numberone.dto.KakaoTokenResponseDto;
import hello.numberone.dto.KakaoUserInfoResponseDto;
...
public class KakaoOAuthService {
    ...
    private String getKakaoAccessToken(String code) {
        ...
        ResponseEntity<KakaoTokenResponseDto> response = restTemplate.postForEntity(
                tokenUri, request, KakaoTokenResponseDto.class
        );
    ...
    private KakaoUserInfoResponseDto getKakaoUserInfo(String accessToken) {
        ...
        ResponseEntity<KakaoUserInfoResponseDto> response = restTemplate.exchange(
                userInfoUri, HttpMethod.GET, request, KakaoUserInfoResponseDto.class
        );
    ...
    private SocialLoginResponseDto loginOrSignup(KakaoUserInfoResponseDto userInfo) {
        ...
        if (userInfo.getKakao_account() != null) {
            ...
            if (userInfo.getKakao_account().getProfile() != null && userInfo.getKakao_account().getProfile().getNickname() != null) {
        ...
        String finalEmail = (email != null && !email.isBlank()) ? email : "kakao_" + providerId + "@kakao.local";
        ...
        return studentRepository.findByProviderAndProviderId(provider, providerId)
                ...
                .orElseGet(() -> {
                    ...
                    // 카카오 로그인 유저는 비밀번호를 모르므로 랜덤 UUID를 암호화해서 저장
